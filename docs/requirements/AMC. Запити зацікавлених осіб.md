...
5. [Функціональність](#5-функціональність)
    ...
    <br>5.4 [Надання функціональності](#53-надання-функціональності)
...
Система запам'ятовує результат запиту і при повторному запиті повертає результат із бази даних.
