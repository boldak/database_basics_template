...
### Open Numbers
Це спільнота для розподільників даних, які гармонізують статистику, щоб зробити її більш придатною для світогляду, заснованого на фактах. Gapminder модерує цей процес, щоб переконатись, що люди, які беруть в ньому участь, знають, що вони роблять.
...
-	Cутність містять одновимірні дані.
...
Сам DDF не визначає формат, в якому зберігаються дані. Неважливо, зберігається він у файлах-csv, базах даних SQL або текстових базах даних. Однак було визначено два формати для збереження моделей DDF: DDFcsv та DDFmongo.
...
Для отримання даних з моделі DDF існує мова запитів Data Description Format Query Language (DDFQL). Ця мова запитів має схожа на SQL, але має специфічні функції для підтримки можливостей моделі даних DDF.
