...
| Функціонал                  | Анімовані дані | Додавання статей користувачем | Створення користувацьких запитів | Прогнозування від наукових установ | Обробка єдиних статистичних стандартів |
| --------------------------- |:--------------:|:-----------------------------:|:--------------------------------:| :--------------------------------: | :------------------------------------: |
| Gapminder                   | +              | -                             | -                                | -                                  | -                                      |
| The World Bank DataBank     | -              | +                             | +                                | -                                  | -                                      |
| Google Public Data Explorer | +              | +                             | -                                | +                                  | +-                                     |
