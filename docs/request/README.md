...
NLP "AMC" представляє собою програмне забезпечення, що дозволяє синтаксично аналізувати медіа-контент(тексти), його зміст, проводити операції токенізації, нормалізації, стемізації, лематизації над ним та його частинами. "AMC" повертає користувачу результат статистичниго аналізу тексту у вигляді діаграм та графіків, що надає користувачу можливість швидко сприймати основний зміст аналізу.
